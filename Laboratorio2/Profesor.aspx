...
<body>
    <table border="1" >
        <tr>
            <td>
                <asp:HyperLink ID="HyperLink1" runat="server">Asignaturas </asp:HyperLink> <br />
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/TareasProfesor.aspx">Tareas</asp:HyperLink> <br />
